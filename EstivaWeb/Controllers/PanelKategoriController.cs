...
namespace EstivaWeb.Controllers
{
    public class PanelKategoriController : Controller
    {
        ...
        // GET: PanelKategori/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: PanelKategori/Create
